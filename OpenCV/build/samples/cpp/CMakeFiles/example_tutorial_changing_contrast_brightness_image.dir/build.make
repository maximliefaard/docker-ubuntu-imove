...
bin/example_tutorial_changing_contrast_brightness_image: /usr/lib/x86_64-linux-gnu/libtbb.so
...
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_dnn.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_ml.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_objdetect.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_shape.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_stitching.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_superres.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_videostab.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_viz.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_photo.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_calib3d.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_features2d.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_flann.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_highgui.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_videoio.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_imgcodecs.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_video.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_imgproc.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: lib/libopencv_core.so.3.4.1
bin/example_tutorial_changing_contrast_brightness_image: /usr/lib/x86_64-linux-gnu/libGL.so
bin/example_tutorial_changing_contrast_brightness_image: /usr/lib/x86_64-linux-gnu/libGLU.so
bin/example_tutorial_changing_contrast_brightness_image: samples/cpp/CMakeFiles/example_tutorial_changing_contrast_brightness_image.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/maxim/OpenCV/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tutorial_changing_contrast_brightness_image"
	cd /home/maxim/OpenCV/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tutorial_changing_contrast_brightness_image.dir/link.txt --verbose=$(VERBOSE)
...
samples/cpp/CMakeFiles/example_tutorial_changing_contrast_brightness_image.dir/clean:
	cd /home/maxim/OpenCV/build/samples/cpp && $(CMAKE_COMMAND) -P CMakeFiles/example_tutorial_changing_contrast_brightness_image.dir/cmake_clean.cmake
...
samples/cpp/CMakeFiles/example_tutorial_changing_contrast_brightness_image.dir/depend:
	cd /home/maxim/OpenCV/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/maxim/OpenCV /home/maxim/OpenCV/samples/cpp /home/maxim/OpenCV/build /home/maxim/OpenCV/build/samples/cpp /home/maxim/OpenCV/build/samples/cpp/CMakeFiles/example_tutorial_changing_contrast_brightness_image.dir/DependInfo.cmake --color=$(COLOR)
